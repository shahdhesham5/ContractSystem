...
class CompanyAdmin(admin.ModelAdmin):
    list_display = ('company_name','manager', 'company_address','phone_number','city','area')
    search_fields = ('company_name','city','area',)

@admin.register(SubCompany)
class SubCompanyAdmin(admin.ModelAdmin):
    list_display = ('sub_company_name', 'parent_company','manager','sub_company_address','phone_number','city','area')
